    ...
    <nav className="bg-primary text-white px-4 py-3 shadow relative z-40">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          {/* Desktop logo */}
          <img src="/logo.png" alt="WildGreen Pest Management Services Logo" className="hidden sm:block h-8 w-8" />
          {/* Mobile logo - larger and more visible */}
          <img src="/logo.png" alt="WildGreen Pest Management Services Logo" className="sm:hidden h-10 w-10" />
