...
const Avadi = ({ onBookClick }) => (
  <div className="px-4 py-8 max-w-4xl mx-auto">
    <Helmet>
      <title>Pest Control in Avadi Chennai | Rodent, Termite, Cockroach Control</title>
      <meta name="description" content="Professional pest control services in Avadi, Chennai. Expert rodent control, termite treatment, cockroach elimination. Same day service. Book now!" />
      <meta name="keywords" content="pest control Avadi, rodent control Avadi, termite control Avadi, cockroach control Avadi, Chennai" />

      {/* Open Graph Tags */}
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://vishwa-pestcontrol.vercel.app/pest-control-avadi" />
      <meta property="og:title" content="Pest Control in Avadi Chennai | Rodent, Termite, Cockroach" />
      <meta property="og:description" content="Professional pest control in Avadi, Chennai. Rodent, termite & cockroach elimination with same-day service." />
      <meta property="og:image" content="https://vishwa-pestcontrol.vercel.app/logo.png" />

      {/* Twitter Card Tags */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:url" content="https://vishwa-pestcontrol.vercel.app/pest-control-avadi" />
      <meta name="twitter:title" content="Pest Control in Avadi Chennai" />
      <meta name="twitter:description" content="Professional pest control services in Avadi - rodent, termite & cockroach control" />
      <meta name="twitter:image" content="https://vishwa-pestcontrol.vercel.app/logo.png" />
    </Helmet>

    <section className="mb-8">
      <h1 className="text-3xl font-bold text-primary mb-4">Pest Control in Avadi, Chennai</h1>
      <p className="text-gray-700 mb-4 text-lg">
        Professional pest control services for Avadi residents. Specializing in rodent control, termite treatment, and cockroach elimination using eco-friendly, family-safe methods.
      </p>

      <div className="bg-green-50 border-l-4 border-primary p-6 rounded mb-6">
        <h2 className="text-xl font-bold text-primary mb-3">Why Choose Us for Pest Control in Avadi?</h2>
        <ul className="list-disc ml-6 space-y-2 text-gray-700">
          <li>Quick response - Same day service in Avadi</li>
          <li>Certified pest control experts</li>
          <li>Safe eco-friendly treatments</li>
          <li>1-year warranty on all services</li>
          <li>Transparent pricing</li>
          <li>Local support for homes and businesses in Avadi</li>
        </ul>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-xl font-bold text-primary mb-3">Rodent Control Avadi</h3>
          <p className="text-gray-600 mb-4">Effective rodent removal for homes and offices in Avadi. Complete rat and mouse control.</p>
          <Link to="/book" className="text-primary font-semibold hover:underline">Book Now →</Link>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-xl font-bold text-primary mb-3">Termite Control Avadi</h3>
          <p className="text-gray-600 mb-4">Expert termite treatment protecting your structures and furniture from damage.</p>
          <Link to="/book" className="text-primary font-semibold hover:underline">Book Now →</Link>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-xl font-bold text-primary mb-3">Cockroach Control Avadi</h3>
          <p className="text-gray-600 mb-4">Safe cockroach elimination for homes and commercial spaces in Avadi.</p>
          <Link to="/book" className="text-primary font-semibold hover:underline">Book Now →</Link>
        </div>
      </div>
      ...
      <Link to="/book" className="block text-center bg-primary text-white px-8 py-3 rounded font-semibold hover:bg-green-700 transition-colors">
        Book Pest Control Service in Avadi
      </Link>
    </section>
