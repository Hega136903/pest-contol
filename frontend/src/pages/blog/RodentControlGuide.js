...
const RodentControlGuide = () => (
  <div className="px-4 py-8 max-w-3xl mx-auto">
    ...
    <article className="bg-white rounded-lg shadow-lg p-8">
      <BlogPostSchema
        headline="Complete Rodent Control Guide for Chennai Homes: Eliminate Rats and Mice Permanently"
        description="Expert rodent control guide for Chennai homes covering signs, risks, prevention and professional treatment."
